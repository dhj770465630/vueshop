<template>
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-table :data="userlist" border stripe style="width: 100%" class="user-tab">
        ...
        <el-table-column label="操作">
          <template v-slot="slot">
            <el-button type="primary" icon="el-icon-edit" @click="showEditDialog(slot.row.id)"></el-button>
            <el-button type="danger" icon="el-icon-delete" @click="open(slot.row.id)"></el-button>
            <el-tooltip effect="dark" content="分配角色" placement="top" :enterable="false">
              <el-button type="warning" icon="el-icon-setting" @click="setRole(slot.row)"></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
